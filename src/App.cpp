...
void App::Draw()
{
    ...
    modelTransfrom = glm::translate(modelTransfrom, glm::vec3(1.0f));
    modelTransfrom = glm::scale(modelTransfrom, glm::vec3(1.0f));
    modelShader.SetMat4("model", modelTransfrom);
    ...
    RenderText(textShader, "Computer Graphics 12:10", 25.0f, 25.0f, 1.0f, glm::vec3(0.5f, 0.8f, 0.2f));
    textShader.UnUse();
}
